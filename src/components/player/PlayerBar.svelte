...
{#if player.currentTrack}
  <div
    class="fixed bottom-0 left-0 right-0 z-50 bg-surface-900/95 backdrop-blur-xl border-t border-white/10 safe-area-bottom"
  >
    ...
    <div class="flex items-center justify-between p-3 md:px-6 h-20 gap-4">
      ...
      <div class="flex items-center gap-4 w-1/3 min-w-0">
        <!-- Placeholder Artwork -->
        <div
          class="w-12 h-12 rounded-md bg-surface-700 flex items-center justify-center shrink-0 shadow-lg border border-white/5 relative overflow-hidden group"
        >
          <span
            class="material-symbols-rounded text-white/20 text-2xl group-hover:scale-110 transition-transform"
            >music_note</span
          >
        ...
        <div class="min-w-0 flex flex-col justify-center">
          <div
            class="font-bold text-white truncate text-sm md:text-base leading-tight"
          >
      ...
      <div class="flex items-center justify-end gap-4 w-1/3 min-w-0">
        <div class="hidden md:flex items-center gap-2 group">
          ...
          <div
            class="w-24 h-1 bg-surface-700 rounded-full relative overflow-hidden"
          >
            <div
            ...
            <input
              ...
              value={player.volume}
              oninput={(e) =>
                player.setVolume(parseFloat(e.currentTarget.value))}
